...
import DragNdrop from '../components/event/DragNdrop.jsx';  // Import the DragNdrop component
import uploadBook from '../tasks/uploadbook.js';  // Import the uploadBook function
...
const CreateBook = () => {
  ...
  return (
    <div>
      <BackButton />
      <h1 className="text-7xl font-extrabold font-fav text-center">Create Book</h1>
      {loading ? (
        ...
        <div className="flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-3 mx-auto">
          ...
          <div className="my-2">
            <DragNdrop onFilesSelected={handleFilesSelected} width="100%" height="200px" /> {/* Add DragNdrop component here */}
          </div>
